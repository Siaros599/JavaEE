...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      <li class="active"><a href="htsachController">Trang chủ</a></li>
      <li><a <%if(kh==null){%> href="#" data-toggle="modal" data-target="#myModal" <% }else {%> href="htgioController" <%} %>>Giỏ hàng</a></li>
      <li><a <%if(kh==null){%> href="#" data-toggle="modal" data-target="#myModal" <% }else {%> href="ttController" <%} %>>Thanh Toán</a></li>
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <form action="dnhomeController" method=post>
		...
		<td width="200" valign="top">
             <table class="table table-hover">
                <%for(Loaibean L:dsloai){ %>
                    <tr>
                        <td><a href="htsachController?ml=<%=L.getMaloai()%>"><%=L.getTenloai() %></a> </td>
                    </tr>
                    <%} %>
             </table>
         </td>
 		<td width="600" valign="top">
          ...
          <%
        	  ...
        	  <tr>
        	  	<td>
        	  		<img src="<%=s.getAnh() %>"><br>
        	  		<a <%if(kh==null){%> href="#" data-toggle="modal" data-target="#myModal" <% }else {%> href="htgioController?ms=<%=s.getMasach()%>&ts=<%=s.getTensach()%>&tg=<%=s.getTacgia()%>&gia=<%=s.getGia()%>" <%} %>> <img src="buynow.jpg"> </a> <br>
        	  		<%=s.getTensach() %><br>
