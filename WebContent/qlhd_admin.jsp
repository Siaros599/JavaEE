  ...
  <tr>
  	<td valign="top"> 		
  		...
  		<tr>
  			...
  			<td style="text-align:center"><a href="xacnhanController?hd=${hdbo.gethd().mahoadon}"><i class="fas fa-check"></i></a></td>
  			<td style="text-align:center"><a href="xoahdController?hd=${hdbo.gethd().mahoadon}"><i class="fas fa-eraser"></i></a></td>
  		</tr>
  		<tr>
  		...
  		<tr>
  			...
  			<td style="text-align:center"><a href="xacnhanController?hd=${hdbo.gethd().mahoadon}&ms=${gh.masach}"><i class="fas fa-check"></i></a></td>
  		</tr>
  		</c:forEach>
